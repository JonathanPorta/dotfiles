...
if ! (exists anaconda); then
  ...
  curl -Lo $INSTALL_DIR/anaconda.sh https://repo.anaconda.com/archive/Anaconda3-2020.02-Linux-x86_64.sh
  chmod +x $INSTALL_DIR/anaconda.sh
  $INSTALL_DIR/anaconda.sh && rm $INSTALL_DIR/anaconda.sh
else

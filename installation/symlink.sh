...
echo "Ensure symlink of '$HOME/.gitconfig' points to '$HOME/dotfiles/.gitconfig'..."
# Replace existing .gitconfig in $HOME with a link to our dotfile version
if [ -f "$HOME/.gitconfig" ]; then
  echo "'$HOME/.gitconfig' already exists - renaming to '$HOME/.gitconfig.old$NOW' and linking to '$HOME/dotfiles/.gitconfig'."
...
if [ -f "$HOME/.oh-my-zsh/oh-my-zsh.sh" ]; then
  echo "'$HOME/.oh-my-zsh/oh-my-zsh.sh' already exists - renaming to '$HOME/.oh-my-zsh.old$NOW' and installing oh-my-zsh"

...
- [ ] **AC-7:** Running the helper with the install-path directory populated exits 0 in <100ms wall-clock and a child `afplay` process is observable in `pgrep afplay` immediately after.
